...
class Equipo
{
    const DEFAULT_QUERY = "SELECT 
                           ...
                           FROM 
                            ...
                            WHERE equ_IdEquipo is not null";
    ...
    {
        $this->query = $this->query . " AND equ_abo_IdAbonadoActual LIKE ?";
        $this->ids[] = $id."%";
    }

    public function byMac($id)
    {
        $this->query = $this->query . " AND equ_MacAdress LIKE ?";
        $this->ids[] = $id."%";
    }

    public function bySerial($id)
    {
        $this->query = $this->query . " AND equ_NroSerie LIKE ?";
        $this->ids[] = $id."%";
    }
